...
from uniforms.models.user import TokenPayload, User
...
# Vrati bcrypt hash hesla v plaintextu; bcrypt je CPU-bound, proto bezi v threadpoolu
...
# Overi shodu plaintextoveho hesla s bcrypt hashem; bezi v threadpoolu
