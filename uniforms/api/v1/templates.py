...
# Telo pozadavku pro vytvoreni nove sablony (nazev souboru bez pripony + YAML obsah)
class TemplateCreateBody(BaseModel):
    filename: str   # slug bez pripony .yaml
    content: str
...
async def create_template(
    ...
    return {
        ...
        "filename": body.filename.removesuffix(".yaml") + ".yaml",
    }
